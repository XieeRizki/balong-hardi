...
<div class="section-header">
    ...
    <a href="{{ route('admin.facility.create') }}" class="btn-create">
    ...
    @forelse ($facilities as $facility)
        <div class="item-card">
            <div class="item-thumb-wrap">
                ...
                <span class="item-status {{ $facility->is_active ? 'status-active' : 'status-inactive' }}">
                    {{ $facility->is_active ? 'Aktif' : 'Nonaktif' }}
                </span>

                <div class="item-actions">
                    <a href="{{ route('admin.facility.edit', $facility) }}" class="act-edit" title="Edit">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                    <form action="{{ route('admin.facility.destroy', $facility) }}" method="POST" onsubmit="return confirm('Hapus fasilitas ini?')">
                        @csrf @method('DELETE')
            ...
            <div class="item-body">
                <p class="item-title" title="{{ $facility->name }}">{{ $facility->name }}</p>
                <p class="item-order">Urutan: {{ $facility->order }}</p>
            </div>
        </div>
    @empty
