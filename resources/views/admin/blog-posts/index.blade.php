    ...
    @forelse ($blogPosts as $post)
        <div class="item-card">
            <div class="item-thumb-wrap">
                ...
                <span class="item-status {{ $post->is_published ? 'status-published' : 'status-draft' }}">
                    {{ $post->is_published ? 'Terbit' : 'Draft' }}
                </span>

                <div class="item-actions">
                    <a href="{{ route('admin.blog-posts.edit', $post) }}" class="act-edit" title="Edit">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                    <form action="{{ route('admin.blog-posts.destroy', $post) }}" method="POST" onsubmit="return confirm('Hapus artikel ini?')">
                        @csrf @method('DELETE')
            ...
            <div class="item-body">
                ...
                @endif
                <p class="item-title" title="{{ $post->title }}">{{ $post->title }}</p>
                <p class="item-date">{{ $post->created_at->format('d M Y') }}</p>
            </div>
        </div>
    @empty
