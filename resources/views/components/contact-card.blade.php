{{--
    Satu kartu info kontak (ikon + judul + isi). Dipake 4x di section Kontak:
    Telepon, WhatsApp, Alamat, Jam Operasional.
...
<div class="card-modern p-8">
    <div class="flex items-start space-x-4">
        ...
        <div>
            <h4 class="text-lg font-bold text-secondary mb-2">{{ $title }}</h4>
            {{ $slot }}
        </div>
    </div>
</div>
